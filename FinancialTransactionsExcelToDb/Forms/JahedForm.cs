...
{
    public partial class JahedForm : Form
    {
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            string[] filePaths = Directory.GetFiles(@"‪C:\Users\Amir\source\repos\FinancialTransactionsExcelToDb\FinancialTransactionsExcelToDb\bin\Debug\New folder");
            ...
            foreach (var filePath in filePaths)
            {
                ...
                int financialAccountId = await GetFinancialAccountId(sessionId, cfaCode);
